...
###############################################################################
# This file currently exists as an example of how to properly make a 'GET'    #
# call to the Google Sheets API. It will be deprecated once these calls have  #
# have actually been implemented in the application. For now, it just reads   #
# a specified range of the data.                                              #
###############################################################################
...
try:
    ...
    # this makes the actual call that 'gets' the data from our sheets. It
